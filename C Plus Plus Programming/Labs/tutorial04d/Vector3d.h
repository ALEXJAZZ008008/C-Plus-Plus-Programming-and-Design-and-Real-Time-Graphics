...
class Vector3d
{
	...
	public:
		...
		*/
		...
		Vector3d Divide(const double n) const;
		...
		* root calculation.
		*/
		double DistanceSqr(const Vector3d &vector) const;
		...
		* The default tolerance can be overidden.
		*/
		bool IsEqual(const Vector3d &vector, double Tolerance = V3_EPSILON) const;
};
