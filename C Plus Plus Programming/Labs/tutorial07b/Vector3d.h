...
public:
	...
	*/
	Vector3d  Add1(const Vector3d &R) const;
	Vector3d  Add2(const Vector3d &R) const;
	Vector3d  Add3(const Vector3d R) const;
	Vector3d  Add4(const Vector3d R) const;
	Vector3d &Add5(const Vector3d &R) const;
	Vector3d &Add6(const Vector3d R) const;
	Vector3d &Add7(const Vector3d &L, const Vector3d &R);
	Vector3d  Add8(const Vector3d &L, const Vector3d &R);
	Vector3d &Add9(const Vector3d &L, const Vector3d &R);
	Vector3d  Add10(const Vector3d &L, const Vector3d &R);
	Vector3d &Add11(const Vector3d &L, const Vector3d &R);
...
inline Vector3d Vector3d::Add10(const Vector3d &L, const Vector3d &R) 
{
...
inline Vector3d &Vector3d::Add11(const Vector3d &L, const Vector3d &R) 
{
	m_x = L.m_x + R.m_x;
	m_y = L.m_y + R.m_y;
	m_z = L.m_z + R.m_z;
